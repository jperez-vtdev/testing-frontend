...
const CMC_URL = `https://${import.meta.env.VITE_ENV === 'prod' ? 'pro' : 'sandbox'}-api.coinmarketcap.com/v1/cryptocurrency/listings/latest`;
const HEADERS = {
  'X-CMC_PRO_API_KEY':
    import.meta.env.VITE_ENV === 'prod' ? API_KEY : TEST_API_KEY,
